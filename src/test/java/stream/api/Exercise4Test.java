...
public class Exercise4Test extends ClassicOnlineStore {
    ...
    public void isThereAnyoneOlderThan40() {
         ...
         */
        boolean olderThan40Exists = customerList.stream().anyMatch(cust -> (cust.getAge() > 40));
    ...
    public void isEverybodyOlderThan20() {
         ...
         */
        boolean allOlderThan20 = customerList.stream().allMatch(cust -> (cust.getAge() > 20));
    ...
    public void everyoneWantsSomething() {
         ...
         */
        boolean everyoneWantsSomething = customerList.stream().allMatch(cust -> (cust.getWantToBuy().size() > 0));
