...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void nameList() {
         ...
         */
        List<String> nameList = customerList.stream().map(cust -> cust.getName()).collect(Collectors.toList());
    ...
    public void ageSet() {
         ...
         */
        Set<Integer> ageSet = customerList.stream().map(cust -> cust.getAge()).collect(Collectors.toSet());
    ...
    public void nameInCsv() {
         ...
         */
        String string = customerList.stream().map(cust -> cust.getName()).collect(Collectors.joining(",", "[", "]"));
    ...
    public void oldestCustomer() {
         ...
         */
        Comparator<Customer> comparatorByAge = (cust1, cust2) -> cust1.getAge().compareTo(cust2.getAge());
    ...
    public void ageDistribution() {
        ...
        Map<Integer, Long> ageDistribution =
                customerList
                        .stream()
                        .collect(Collectors.groupingBy(cust -> cust.getAge(), Collectors.counting()));
