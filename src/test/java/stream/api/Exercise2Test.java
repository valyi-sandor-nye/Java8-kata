...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(cust -> cust.getAge()).sorted();
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = ((i1, i2) -> ((i1 > i2) ? -1 : ((i1 == i2) ? 0 : 1)));
        Stream<Integer> sortedAgeStream = customerList.stream().map(cust -> cust.getAge()).sorted(descOrder);
    ...
    public void itemsCustomersWantToBuy() {
         ...
         */
        Function<Customer, Stream<Item>> getItemStream = cust -> cust.getWantToBuy().stream();
